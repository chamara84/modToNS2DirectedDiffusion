...
class LevelEntry{
public:
    LevelEntry(NRAttrVec *attrs, int level_hierachy )
    {level_attrs_ = attrs;
    level_=level_hierachy;
    };
    
    NRAttrVec *level_attrs_;
    int level_;
};
...
typedef list<LevelEntry *> LevelList;
...
//my stuff
  ...
  LevelEntry * matchLevelEntry(NRAttrVec *attrs);
